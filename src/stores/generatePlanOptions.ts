...
export function generatePlanOptions(selected_fields, repeated_courses, current_enrollments, past_enrollments, completed_credits) {
  let plan_options = [];
  ...
  for (let field of selected_fields) {
