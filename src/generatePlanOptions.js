...
export function generatePlanOptions(selected_fields, repeated_courses, completedClassList, inProgressClassList, fields) {
  let plan_options = [];
  ...
  fields.filter((field) => {
    selected_fields.map((selected_field) => {
