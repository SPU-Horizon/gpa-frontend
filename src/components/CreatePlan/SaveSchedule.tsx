...
const SaveSchedule: React.FC = () => {
    ...
    return (
        <div className="flex flex-grow  min-h-[500px] m-12 pb-4 ">
            <Paper className="flex flex-col w-full rounded overflow-hidden border border-gray-100 bg-white-light dark:border-gray-700 dark:shadow-gray-700/50 dark:bg-black-light">
                ...
                <Select
                    ...
                    className="w-1/2 ml-4 dark:bg-black-light" 
                />

                {/* Display the selected schedule */}
                {selectedSchedule && (
                    <div className="mt-4">
                        <Card withBorder p="lg" className="flex flex-col w-full bg-white-dark border border-gray-100 dark:border-gray-700 dark:bg-black-light">
                            <div className="font-bold mb-2">{selectedSchedule.name}</div>
                            <div className="grid grid-cols-3 gap-4 dark:bg-gold-base dark:text-white-base">
